...
#
html_theme_options = {}
html_logo = "../media/logo_nameless_png.png"
...
latex_documents = [
    (master_doc, 'n2v.tex', 'n2v Documentation',
     'n2v', 'manual'),
]
...
man_pages = [
    (master_doc, 'n2v', 'n2v Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'n2v', 'n2v Documentation',
     author, 'n2v', 'Density-to-potential inversion module',
     'Miscellaneous'),
]
